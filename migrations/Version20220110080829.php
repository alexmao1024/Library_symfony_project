 ...
 */
final class Version20220110080829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subscribe (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, subscribe_at DATETIME NOT NULL, INDEX IDX_68B95F3E16A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
